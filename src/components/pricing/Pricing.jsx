    ...
    return (
        <section id="pricing" className="pricing-section">
            ...
            <div className="pricing-inner">
                ...
                <div className="max-w-4xl mx-auto mb-16 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-blue-200 dark:border-blue-800 overflow-hidden relative group">
                    ...
                    <div className="p-8 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
                        <div className="text-center md:text-left flex-1">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 text-xs font-bold uppercase tracking-wider mb-3">
                                <span className="w-2 h-2 rounded-full bg-blue-600 animate-pulse"></span>
                                Free 30-Min Session
                            </div>
                            <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2">Book a Strategy Call</h3>
                            <p className="text-slate-600 dark:text-slate-400">Not sure which plan is right for you? Let's discuss your bottlenecks and map out a custom growth roadmap before you commit to anything.</p>
                        </div>
                        <div className="shrink-0 w-full md:w-auto">
                            <Link to="/book-session" className="inline-flex items-center justify-center gap-2 w-full md:w-auto px-8 py-4 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/25 whitespace-nowrap group-hover:scale-[1.02] duration-300">
                                Book Free Call <i className="fas fa-arrow-right"></i>
                            </Link>
                        </div>
                    </div>
                </div>
